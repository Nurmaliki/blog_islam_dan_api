                                        ...
                                        <div class="card-block px-0 py-3">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    <tbody>
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="<?php echo base_url()."/public/";?>images/user/avatar-1.jpg" alt="activity-user"></td>
                                                            <td>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="<?php echo base_url()."/public/";?>images/user/avatar-2.jpg" alt="activity-user"></td>
                                                            <td>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="<?php echo base_url()."/public/";?>images/user/avatar-3.jpg" alt="activity-user"></td>
                                                            <td>
                                        ...
                                        <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="<?php echo base_url()."/public/";?>images/user/avatar-1.jpg" alt="activity-user">Ida Jorgensen</h6>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="<?php echo base_url()."/public/";?>images/user/avatar-2.jpg" alt="activity-user">Albert Andersen</h6>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="<?php echo base_url()."/public/";?>images/user/avatar-3.jpg" alt="activity-user">Silje Larsen</h6>
                                                        </td>
                                                        <td>
