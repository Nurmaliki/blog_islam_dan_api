...
<body class="bg-white">
    ...
    <div id="payment-bank">
            ...
            <div class="container" style="padding-top:30px">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        ...
                        <h4 class="text-white">Kami mengucapkan terimakasih atas kesediaan kaka untuk bersedekah dan mendukung kami untuk terus memberikan layanan terbaik kami untuk umat</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="mb-5">
                                ...
                                <em>
                                    <h2 class="testimonial-text">“Barangsiapa tidak memiliki guru maka gurunya adalah syaithan.”</h2>
                                </em>
                            </div>
        ...
        <div style="background: #aea9a9">
            <div class="container">
                <h1 class="text-center  text-white" style="padding-top:20px">MENGAPA BERSEDEKAH DI DEPAN?</h1>
                <div class="row">
        ...
        <div style="background:#00b0f0;color:#fff;">
            <div class="container text-center display-5 font-weight-bold">
                <h1 class="text-white">BERAPA SEDEKAHNYA?</h1>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <p class="text-black">Kami tidak membatasi kebaikan kaka. Siapkan sedekah terbaik kaka untuk memdukung layanan kami</p>
                        <p class="text-black display-6">Dengan sedekah ini, kaka juga telah ikut berkontribusi dalam menyebarkan dakwah islam yang rahmatan lil alamin lewat teknologi digital.</p>
                        ...
                        <div class="box-infa text-center" style="border: 4px solid #ce3838;border-style: dashed;margin: auto;background: #f6c3c3;padding: 10px;">
                            <h2 class="text-black">PILIH PAKET SEDEKAH</h2>

                            <div class="box-options-konsultasi">
                                <div class="text-left">
                                    <p style="margin-bottom:1px">
                                        <input type="radio" id="minggu" name="radio-paket" data-prodak="4" data-person="<?php echo $resultperson->id; ?>" onclick="return valData(this)">
                                        <label for="minggu">Paket Sedekah Konsultasi Online SyariaID 7 Hari</label>

                                    <ul class="text-black" style="margin-left: 20px;">
                                        <li>Konsultasi Selama 7 Hari</li>
                                        <li>Tergabung dalam Channel Dakwah Selama 1 Minggu </li>
                                        <li>Sedekah Dasar Rp 29.000 + Sedekah Sukarela</li>
                                        <li>Jam layanan konsultasi 07:00 – 22:00 WIB setiap hari</li>
                                    </ul>
                                    </p>
                                    <p style="margin-bottom:1px">
                                        <input type="radio" id="bulan" name="radio-paket" data-prodak="5" data-person="<?php echo $resultperson->id; ?>" onclick="return valData(this)">
                                        <label for="bulan">Paket Sedekah Konsultasi Online SyariaID 30 Hari</label>
                                    <ul class="text-black" style="margin-left: 20px;">
                                        <li>Konsultasi Selama 30 hari</li>
                                        <li>Tergabung dalam Channel Dakwah Selama 1 Bulan </li>
                                        <li>Sedekah Dasar Rp 99.000 + Sedekah Sukarela</li>
                                        <li>Jam layanan konsultasi 07:00 – 22:00 WIB setiap hari</li>
                                    </ul>
                                    </p>
                                </div>
                            ...
                            <div class="clearfix"></div>
                            <div class="blink">
                                Silahkan isi Sedekah Sukarela sesuai dengan keikhlasan Kaka</div>
                        </div>
                        <div class="clearfix"></div>
        ...
        <div class="section-space20">
            <div class="container">
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <button class="btn button_pay text-center font-weight-bold" style="background: #ffc107;color: #fffbfb;border-radius: 40px;font-size:36px" name="send-message" id="form-input-btn">SEDEKAH SEKARANG</button>
                </div>
            </div>
            <?php $resultprodak = $resultprodak[0]; // print_r($resultprodak); 
            ?>
