...
input[type="number"] {
    ...
    .text-topim{font-size: 24px;text-align: left !important;}
    ...
    </style><script>var _url = "<?php echo str_replace('http','https',base_url());?>";</script>
</head>
        ...
        <div class="container">
            <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                ...
                <div class="section-title text-center">
                            <em><h3 class="text-white">Jangan sampai nyesel setelah nikah, gara-gara gak persiapan. Ingat, waktu gak bisa diulang</h3></em>
                    </div>
            </div>   
    </div>   
    </div>   
    ...
    <div class="section-space20">
        <div class="container">
            <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                ...
                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="section-title text-center mb60">
                            <em><h2 >Menurut data terkini jumlah perceraian di Indonesia pada tahun ini (2020) sebesar <b>306.688</b> per agustus.</h2></em>
                        <div class="clearfix"></div>
    ...
    <div class="section-space20 bg-light-blue how-it-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div onclick="this.style.display='none'; this.nextSibling.style.display='block';"><img src="<?php echo base_url()."/public/";?>images/web/nikah/vid_1.png" style="cursor:pointer" /></div><div style="display:none">
               <embed src="https://youtube.com/v/e_W9DHl53fk?&autoplay=1&mute=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="100%" height="344"></embed></object>
                ...
                <div class="col-lg-6 col-md-12 col-12" style="padding-bottom: 10px;">
                <div onclick="this.style.display='none'; this.nextSibling.style.display='block';"><img src="<?php echo base_url()."/public/";?>images/web/nikah/vid_2.png" style="cursor:pointer" /></div><div style="display:none">
               <embed src="https://youtube.com/v/e_W9DHl53fk?autoplay=1&mute=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="100%" height="344"></embed></object>
                </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12" style="padding-bottom: 10px;">
                <div onclick="this.style.display='none'; this.nextSibling.style.display='block';"><img src="<?php echo base_url()."/public/";?>images/web/nikah/vid_3.png" style="cursor:pointer" /></div><div style="display:none">
               <embed src="https://youtube.com/v/e_W9DHl53fk?autoplay=1&mute=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="100%" height="344"></embed></object>
                </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12" style="padding-bottom: 10px;">
                <div onclick="this.style.display='none'; this.nextSibling.style.display='block';"><img src="<?php echo base_url()."/public/";?>images/web/nikah/vid_4.png" style="cursor:pointer" /></div><div style="display:none">
               <embed src="https://youtube.com/v/e_W9DHl53fk?autoplay=1&mute=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="100%" height="344"></embed></object>
                </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12" style="padding-bottom: 10px;">
                <div onclick="this.style.display='none'; this.nextSibling.style.display='block';"><img src="<?php echo base_url()."/public/";?>images/web/nikah/vid_5.png" style="cursor:pointer" /></div><div style="display:none">
               <embed src="https://youtube.com/v/e_W9DHl53fk?autoplay=1&mute=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="100%" height="344"></embed></object>
                </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12" style="padding-bottom: 10px;">
                <div onclick="this.style.display='none'; this.nextSibling.style.display='block';"><img src="<?php echo base_url()."/public/";?>images/web/nikah/vid_6.png" style="cursor:pointer" /></div><div style="display:none">
               <embed src="https://youtube.com/v/e_W9DHl53fk?autoplay=1&mute=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="100%" height="344"></embed></object>
                </div>
                </div>
            </div>
                ...
                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="rp-infaq bg-light-blue" style="display: inline-flex;padding: 10px;background-color: #c85c33">
                            ...
                            <div class="rp-infaq bg-light-blue" style="display: inline-flex;padding: 10px;">
                                <div class="row" style="padding: 10px;">
                                    <h1 style="padding-right: 10px;" class="text-white">Rp</h1>
                                    <input type="text" maxlength="10" class="infaq" value="125.000" readonly/>
                                </div>
                            </div>
                    </div>
                </div>
...
<script>
    ...
    $.ajax({
      type:'POST',  
      url: _url+'payment',
      data:{'data':$("#valdata").val(),'infaq':$(".infaq").val()},
      cache: false,
