                    ...
                    <article class="news-detail">
                        <header class="news-detail__meta">
                            <ul class="meta font-small">
                                <li>Mereka Yang Telah Mendapat Manfaat</li>
                                <!-- <li>Artikel</li> -->
                                <li>
                    ...
                    <div class="item-6 m:item-6">
                        <article class="news flex news--y">
                            <figure class="news__figure">
                                <a  href="/artikel/detail/<?php print_r($value->id);  ?>">
                                    <img src="/asset/status/<?php print_r($value->image); ?>" alt="" class="lazyload">
                                </a>
                            </figure>
                            <div class="news__info">
                                <a  href="/artikel/detail/<?php print_r($value->id);  ?>" class="link"><?php echo $value->judul; ?></a>
                                <ul class="meta font-small">
