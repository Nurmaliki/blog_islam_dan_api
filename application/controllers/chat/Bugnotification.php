...
class Bugnotification extends CI_Controller {
	...
	function MailTo($po){
		...
		if($data->status=="201"){
			...
			$html.='<strong>Untuk bantuan silahkan hubungi no 085716204599 via Whatsapp</strong><br/><br/><br/><br/>
